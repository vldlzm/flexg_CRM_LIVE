    ...
    screens: [
      ...
      },
      {
        ...
        notes: [
          ...
          'APP푸시 알림의 우측 썸네일 이미지는 해당 LIVE 방송에 등록된 상품 중 가장 먼저 등록된 상품의 이미지가 자동으로 적용됩니다.',
          '사용자는 랜딩 URL 옆 불러오기 버튼을 통해 URL 생성 팝업을 열어 생성 유형과 유입 채널을 선택하여 URL을 수정하거나 재설정할 수 있습니다.',
          '와이드 리스트 : 상품명은 최대 14자로 제한하며, 초과 시 말줄임표(...)로 처리합니다. 가격은 최대 10자로 제한하며, 상품명과 가격은 줄바꿈으로 구분하여 표시합니다. 상품명과 가격을 합산한 총 글자 수는 최대 30자입니다.',
          '와이드 리스트 : 라이브 방송명은 최대 25자 입니다.',
        ],
      },
      {
      ...
      },
      {
        ...
        notes: [
          '구매 상품 항목에서 특정 상품 클릭 시 여러 상품을 동시에 선택할 수 있습니다. 선택 조건은 기존 AND에서 OR로 변경되며, 선택된 상품 중 하나라도 구매한 고객이 조건에 포함됩니다.',
